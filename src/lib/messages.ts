...
const uk = {
  ...
  mine: {
    ...
    upcoming: 'Майбутні',
    past: 'Минулі',
    emptyUpcomingTitle: 'Немає майбутніх бронювань',
    emptyUpcomingText: 'Оберіть кімнату й натисніть вільний слот у розкладі.',
    emptyPastTitle: 'Минулих бронювань немає',
    emptyPastText: 'Тут зʼявляться зустрічі, які вже відбулися.',
    toRooms: 'До кімнат',
  ...
  dialog: {
    ...
    titlePlaceholder: 'Наприклад: синк з дизайном',
    duration: 'Тривалість',
    freeUntil: 'До наступного бронювання або кінця дня вільно',
    minutes: 'хв',
    hours: 'год',
    officeTimeIs: 'За часом офісу',
    book: 'Забронювати',
    booking: 'Бронюємо…',
    close: 'Скасувати',
  },
...
const en: Dictionary = {
  ...
  mine: {
    ...
    emptyUpcomingText: 'Pick a room and click a free slot in the schedule.',
    emptyPastTitle: 'No past bookings',
    emptyPastText: 'Meetings that already happened will show up here.',
    toRooms: 'Go to rooms',
  ...
  dialog: {
    ...
    titlePlaceholder: 'For example: design sync',
    duration: 'Duration',
    freeUntil: 'Free until the next booking or the end of the day',
    minutes: 'min',
    hours: 'h',
    officeTimeIs: 'Office time',
    book: 'Book',
    booking: 'Booking…',
    close: 'Cancel',
  },
